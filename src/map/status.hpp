...
/// @APIHOOK_START(EFST_ENUM)
	...
	EFST_ARMOR_ELEMENT_FIRE = 1183, // Resist Potion Fire
	EFST_ARMOR_ELEMENT_WIND = 1184, // Resist Potion Wind
	EFST_ARMOR_ELEMENT_WATER = 1185, // Resist Potion Water
	EFST_ARMOR_ELEMENT_EARTH = 1186, // Resist Potion Earth
	EFST_ARMOR_RESIST = 1187, // Undead Scroll

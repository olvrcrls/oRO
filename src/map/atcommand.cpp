...
ACMD_FUNC(go)
{
	...
	const struct {
		...
		{ MAP_MORA,         108, 66 }, // 31=Mora
		{ MAP_DEWATA,      200, 180 }, // 32=Dewata
		{ MAP_MALANGDO,    128, 126 }, // 33=Malangdo Island
...
#include "../custom/atcommand_def.inc"
		...
		ACMD_DEF(mobinfo),
		ACMD_DEF2("mi", mobinfo),
		ACMD_DEF2("monsterinfo", mobinfo),
		ACMD_DEF(exp),
		ACMD_DEF(version),
		ACMD_DEF(mutearea),
		ACMD_DEF(rates),
		...
		ACMD_DEF2("immune", monsterignore),
		ACMD_DEF(fakename),
		ACMD_DEF(size),
		ACMD_DEF(showexp),
		ACMD_DEF(showzeny),
